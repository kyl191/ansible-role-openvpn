...
| openvpn_ca_key_pass                | string  |              |                                                | If `openvpn_ca_key` is provided and it's protected by pass phrase, set it here. Requires the pexpect module (install with pip before running this role)           |
